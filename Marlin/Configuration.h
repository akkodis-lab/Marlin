...
#define STRING_CONFIG_H_AUTHOR "AKKODIS" // Who made the changes.
...
#define TRIGORILLA_MAPPING_I3MEGA     // Servo Mapping 
#define SWAP_Z_MOTORS                // correct order of the Z-Motors on this Board
// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "AKKODIS Anycubic I3 Mega S"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 414 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 14, -45, -2.10 }
...
#define Z_PROBE_FEEDRATE_FAST (10*60)
#define Z_PROBE_FEEDRATE (Z_PROBE_FEEDRATE_FAST/2)
